...
const deleteItem = (req, res) => {
   ...
   * @apiHeader {String} x-api-key Api key value
   *
   * @apiParam (Body) [params] Any destructed params that should be present in searched items. If no params specified, endpoint will delete all object of the table
   *
   * @apiSuccess {String} data  Success message
   * @apiSuccessExample Success response:
   *     HTTP/1.1 200 OK
